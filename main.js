...
function popup(projectIndex) {
  ...
  g('modalTechnologies', true).innerHTML = "<ul>" + unescape(technologies.join('')) + "</ul>"
  g('modalTextMobile', true).innerText = project.bigDescription;
  g('modalLinkSource', true).innerHTML = `<button type="button" onclick="javascript:window.open('${project.linkSource}', '_blank');" formtarget="_blank">
  Visualizar Código<span>
  ...
  g('modalCardsList', true).innerHTML = `<ul class="cards-container">
      ...
      <div class="contents-two">
        ...
        <div class="card-detail-box">
          <ul class="cards-container">
            <li class="card-detail canopy">${project.details[0]}</li>
            <li class="card-detail option">
              <img src="assets/bullets.png" alt="bullet" class="circle" />
              ${project.details[1]}
            </li>
